...
//defining reigsters 
#define SLAVE_ADDR_WRITE  0xB8
#define SLAVE_ADDR_READ   0xB9
...
uint8_t First_Barometer_DataXL[1];
uint8_t First_Barometer_DataL[1];
uint8_t First_Barometer_DataH[1];
...
// aşşagıdaki fonksiyonları açıklamsı .c dosyasında mevcuttur
void BarometerInit();
